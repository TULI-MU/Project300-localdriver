...
<h3>Edit_Fare
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your place_id_from" value="<?php if(set_value('place_id_from')){ echo set_value('place_id_from');}else{ echo $fare[0]['place_id_from'];}?>" name="place_id_from"  >

	</div>

	<div class="error"><?=form_error('place_id_from')?></div>

<div class="form-group">

		<input type="text" class="form-control" placeholder="Enter Your place_id_to" value="<?php if(set_value('place_id_to')){ echo set_value('place_id_to');}else{ echo $fare[0]['place_id_to'];}?>" name="place_id_to"  >

	</div>

	<div class="error"><?=form_error('place_id_to')?></div>


<div class="form-group">

		<input type="text" class="form-control" placeholder="Enter Your fare" value="<?php if(set_value('fare')){ echo set_value('fare');}else{ echo $fare[0]['fare'];}?>" name="fare"  >
...
<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your vehicle" value="<?php if(set_value('vehicle')){ echo set_value('vehicle');}else{ echo $fare[0]['vehicle'];}?>" name="vehicle"  >

	</div>

	<div class="error"><?=form_error('vehicle')?></div>
