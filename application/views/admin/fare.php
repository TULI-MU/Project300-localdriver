...
<h3>Fare 
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your f_id" value="<?=set_value('f_id')?>" name="f_id"  >

	</div>

	<div class="error"><?=form_error('f_id')?></div>


	<div class="form-group">

		<input type="text" class="form-control" placeholder="Enter Your place_id_from" value="<?=set_value('place_id_from')?>"  name="place_id_from"  >
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your place_id_to" value="<?=set_value('place_id_to')?>"  name="place_id_to"  >
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your fare" value="<?=set_value('fare')?>" name="fare"  >
...
<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your Vehicle" value="<?=set_value('vehicle')?>" name="vehicle"  >
