...
<h3>Vehicle_info 
	...
	<div class="error"><?=form_error('v_id')?></div>
<div class="form-group">

	<input type="text" class="form-control" placeholder="Enter Your place_id" value="<?=set_value('Place_id')?>"
	name="Place_id">
...
<div class="error"><?=form_error('vehicle_name')?></div>
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your vehicle_name" value="<?=set_value('vehicle_name')?>"  name="vehicle_name"  >
