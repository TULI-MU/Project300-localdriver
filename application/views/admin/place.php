...
<h3>Add Place 
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your p_id" value="<?=set_value('p_id')?>" name="p_id"  >

	</div>

	<div class="error"><?=form_error('p_id')?></div>


	<div class="form-group">

		<input type="text" class="form-control" placeholder="Enter Your place_name" value="<?=set_value('place_name')?>"  name="place_name"  >
