...
<section class="contact py-5">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" placeholder="Enter Your Age" value="<?=set_value('age')?>"  name="age"   >

	</div>

		<div class="error"><?=form_error('age')?></div>
...
<div class="form-group">
		...
		<input type="radio"  name="user_type"  value="Driver" >Driver
